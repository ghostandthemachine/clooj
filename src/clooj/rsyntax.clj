...
(ns ^{:doc "Support for RSyntaxTextArea: http://fifesoft.com/rsyntaxtextarea/index.php"
  ...
  (:require [seesaw.core :as core]
            ...
            clojure.reflect
            clojure.string)
  (:import [org.fife.ui.rsyntaxtextarea SyntaxConstants Theme])
...
(defn theme [text-area xml-theme]
  (let [thr (Thread/currentThread)
        theme (Theme/load (.getResourceAsStream (.getContextClassLoader thr) xml-theme))]
